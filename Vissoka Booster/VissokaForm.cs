...
{
    public partial class VissokaForm : Form
    {
        public VissokaForm()
        {
            InitializeComponent();
        ...
        private void TopPanel_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                _MaxButton.Image = Properties.Resources.form_mOff;
            }
            else
            {
        ...
        private void _MaxButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.Size = new System.Drawing.Size(rect.Width, rect.Height);
                toolTip1.SetToolTip(_MaxButton, "Restore Down");
                _MaxButton.Image = Properties.Resources.form_mOn;
                isWindowMaximized = true;
            }
        }
        ...
        private void VissokaForm_TextChanged(object sender, EventArgs e)
        {
            WindowTextLabel.Text = this.Text;
            Refresh();
        }
